...
$UNI_NAME_CLEAN = 'Stud.IP 3.5';                           //the clean-name of your master-faculty (e.g. University of Göttingen), without html-entities (used for mail-system)
...
$DB_STUDIP_HOST = "mariadb";
$DB_STUDIP_USER = "root";
$DB_STUDIP_PASSWORD = "change_me";
...
$ABSOLUTE_URI_STUDIP = "http://localhost:10080/";
...
$MAIL_HOST_NAME = "mail.uni-halle.de";                               //which mailserver should we use? (must allow mail-relaying from $MAIL_LOCALHOST, defaults to SERVER_NAME)
...
$PHPASS_USE_PORTABLE_HASH = false;           //use portable (less secure) hashing algo for passwords
